    ...
    <div id="content-page" class="content-page">
        <div class="container">
            <div class="row">
                        ...
                        <div class="iq-card-body profile-page p-0">
                            <div class="profile-header">
                                ...
                                <div class="cover-container">
                                    ...
                                    <img src="{{asset('/storage/folder/back.png')}}" alt="profile-bg" class="rounded img-fluid">

                                </div>
                                <div class="user-detail text-center mb-3">
                                    <div class="profile-img-edit">
                                        <img class="profile-pic" style="height: 100%" src="{{asset($user->getIcon())}}" alt="profile-pic">
                                    </div>
                                    ...
                                    <div class="profile-detail">
                                        ...
                                        @if(Auth::id() == $user->id)
                                            <a href="{{route('profile.edit')}}"><i class="ri-pencil-line"></i>Изменить профиль</a>
                                    ...
                                    <div class="social-info">
                                        <ul class="social-data-block d-flex align-items-center justify-content-between list-inline p-0 m-0">
                                            <li class="text-center pl-3">
                                                <h6>Posts</h6>
                                                <p class="mb-0">{{$user->countPost()}}</p>
                                            </li>
                                            <li class="text-center pl-3">
                                                <h6>Followers</h6>
                                                <p class="mb-0">{{$user->countFollowers()}}</p>
                                            </li>
                                            <li class="text-center pl-3">
                                                <h6>Following</h6>
                                                <p class="mb-0">{{$user->countSubscribers()}}</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                @if(User::isFriend($user->id) OR (Auth::id() == $user->id))
                    <div class="col-sm-12">
                            ...
                            <div class="tab-pane fade active show" id="timeline" role="tabpanel">
                                <div class="iq-card-body p-0">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <div class="iq-card">
                                                <div class="iq-card-header d-flex justify-content-between">
                                                    ...
                                                    <div class="iq-card-header-toolbar d-flex align-items-center">
                                                        <p class="m-0"><a href="javacsript:void();">All</a></p>
                                                    </div>
                                                </div>
                                                <div class="iq-card-body">
                                                    <ul class="profile-img-gallary d-flex flex-wrap p-0 m-0">
                                                        @foreach($user->getSubscribers() as $item)
                                                            <li class="col-md-4 col-6 pl-2 pr-0 pb-3">
                                                                <a href="{{route('profile', [$item->id])}}">
                                                                    <img src="{{$item->getIcon()}}" alt="gallary-image" class="img-fluid" /></a>
                                        ...
                                        <news-paginate :user="{{json_encode($user)}}" :current_user="{{$current_user}}" :url_request="{{$url_request}}"></news-paginate>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12">
                        Closed profile
                        @if($user->checkSubscribers())
                            @if(!User::isFriend($user->id))<p>Заявка отправлена...</p>
                            <button type="submit" value="{{$user->id}}" id="btn_d_{{$user->id}}" class="btn btn-primary btn-describe">Отписаться</button>
                            @endif
                        @else
                            <button type="submit" value="{{$user->id}}" id="btn_s_{{$user->id}}" class="btn btn-primary btn-subscribe">Подписаться</button>
                            <button type="submit" value="{{$user->id}}" style="display: none" id="btn_d_{{$user->id}}" class="btn btn-primary btn-describe">Отписаться</button>
                        @endif
                    </div>
                @endif
            </div>
